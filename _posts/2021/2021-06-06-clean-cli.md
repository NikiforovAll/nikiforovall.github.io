...
description: In this blog post I will show you how to develop powerful console applications that could benefit of your existing Clean Architecture projects in a great way.
fullview: false
comments: true
related: true
---

![help-command](/assets/2021/clean-cli/help-command.png)
...
![migrate-command](/assets/2021/clean-cli/migrate-command.png)

Create todo list:

![create-todolist-command](/assets/2021/clean-cli/create-todolist-command.png)

List commands:

![list-command](/assets/2021/clean-cli/list-command.png)

See todo list details:

![list-command](/assets/2021/clean-cli/todo-details-command.png)
