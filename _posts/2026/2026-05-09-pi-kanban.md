...
tags: [ai, agents, developer-tools, cli]
published: true
shortinfo: "An observability dashboard for pi.dev — sessions, todos, subagents, and pinned context in one place."
description: "An observability dashboard for pi.dev — sessions, todos, subagents, and pinned context in one place."
fullview: false
comments: true
related: true
mermaid: false
...
![Subagent view](https://raw.githubusercontent.com/NikiforovAll/pi-kanban/main/assets/pi-subagent.png){:width="80%" style="display:block;margin:0 auto"}
...
![Session info modal](https://raw.githubusercontent.com/NikiforovAll/pi-kanban/main/assets/pi-info.png){:width="80%" style="display:block;margin:0 auto"}

### Storage manager

Lists sessions, scratchpads, and linked docs with size accounting. Used to clean orphaned docs and unlink stale references.

![Storage manager](https://raw.githubusercontent.com/NikiforovAll/pi-kanban/main/assets/pi-storage-explorer.png){:width="80%" style="display:block;margin:0 auto"}
...
![Follow last message](https://raw.githubusercontent.com/NikiforovAll/pi-kanban/main/assets/pi-follow-last-message.png){:width="80%" style="display:block;margin:0 auto"}
...
![Light theme](https://raw.githubusercontent.com/NikiforovAll/pi-kanban/main/assets/pi-kanban-poster-light.png){:width="80%" style="display:block;margin:0 auto"}
