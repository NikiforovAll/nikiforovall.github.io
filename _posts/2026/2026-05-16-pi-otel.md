...
published: true
shortinfo: "Add OpenTelemetry traces, metrics, and logs to the pi coding agent — one trace tree per turn, exported to Aspire, Grafana, or any OTLP backend."
description: "Add OpenTelemetry traces, metrics, and logs to the pi coding agent — one trace tree per turn, exported to Aspire, Grafana, or any OTLP backend."
fullview: false
comments: true
related: true
mermaid: false
