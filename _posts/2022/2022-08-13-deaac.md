...
description: Learn how to build a repeatable codespace configuration for all users of your project.
fullview: false
comments: true
related: true
mermaid: true
...
<center>
    <img src="/assets/2022/deaac/remote-arch.png" alt="remote-arch">
</center>
...
<center>
    <img src="/assets/2022/deaac/codespaces-diagram.png" alt="codespaces-diagram">
</center>
...
<img src="/assets/2022/deaac/configure-dotfiles.png" alt="configure-dotfiles">

2️⃣ Go to repository and launch a codespace:

<img src="/assets/2022/deaac/launch-codespace.png" alt="launch-codespace">

3️⃣ Open the codespace in the browser or locally (I will go with browser option for the demo)

<img src="/assets/2022/deaac/codespace-welcome.png" alt="codespace-welcome">
...
<img src="/assets/2022/deaac/azd-up.png" alt="azd-up">

6️⃣ Setup the breakpoint

<img src="/assets/2022/deaac/debug-in-codespace.png" alt="debug-in-codespace">

7️⃣ Inspect forwarded ports. Note, codespaces allocates some random URL 

<img src="/assets/2022/deaac/port-forwarding-panel.png" alt="port-forwarding-panel">

8️⃣ Generate load

<img src="/assets/2022/deaac/forwarded-port.png" alt="forwarded-port">

9️⃣ Inspect logs by running `azd monitor --logs`

🔟 Tear down the dev environment in Azure `azd down`

<img src="/assets/2022/deaac/azd-down.png" alt="azd-down">
